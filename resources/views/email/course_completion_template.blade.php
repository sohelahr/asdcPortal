            ...
            <div>
                ...
                <div>
                    <div style = "padding: 5%;">
                        ...
                        <p><b>ASDC Congratulates You!</b></p>
                        <p>Thankyou for getting with us in your academic journey!</p>
                    </div>
                    <div style = "margin-top: 100px; margin-left: 5%; margin-right: 5%;">
                        <p>You have successfully completed the course for Graphics Designing and certified.</p>
                    </div>
                    <div style = "padding: 5%">
                         If you wish to join any other course, we would like to help you in future!
                    </div>
