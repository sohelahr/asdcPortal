                            ...
                            <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input required type="text" value="{{$instructor->designation}}" class="form-control" name="designation"
                                                >
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <sub>(Dont upload if dont want to change)</sub>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        class="form-control" name="address">{{$instructor->address}}</textarea>
                                    </div>
                                </div>
                            </div>
